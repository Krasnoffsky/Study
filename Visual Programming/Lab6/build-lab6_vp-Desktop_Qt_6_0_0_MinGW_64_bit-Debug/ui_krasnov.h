...
public:
    ...
    void setupUi(QWidget *krasnov)
    {
        ...
        krasnov->setStyleSheet(QString::fromUtf8("QPushButton:hover {background: rgb(243, 255, 17)}\n"
"QPushButton {background: rgb(200, 255, 17); color: black}\n"
"QLabel {background: rgb(243,255,150);  border-color: rgb(45,45,45)}\n"
"QTextEdit {background: rgb(243,255,150)}\n"
"QWidget{background-color: rgb(243,255,150)}\n"
"\n"
"\n"
"\n"
"\n"
